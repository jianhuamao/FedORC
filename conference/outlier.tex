...
The figure shows that FedOCR changes the pool, not just the pool size.
Compared with the alternatives, it keeps a subset that is cleaner and more class-complete.
That matters because reliability alone can leave coverage gaps, while diversity alone can keep noisy clients.
FedOCR avoids both failures by balancing the two.

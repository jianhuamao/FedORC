...
The controlled oracle validation is moved to Appendix~\ref{app:oracle_experiment_details}; it is used only to check whether the risk factors in Theorem~\ref{thm:main_bound} rank retained client-block sets in the expected order.
...
The oracle figures below show the same qualitative pattern described in the main text.

...
The main experiments use linear and Gaussian heterogeneous noise to cover two complementary cases: linear noise is a controllable high-noise stress test, while Gaussian noise models a more random corruption pattern that is closer to practical uncertainty.
...
\end{itemize}
Additional implementation details are provided in Appendix~\ref{app:experiment_setup_details}.

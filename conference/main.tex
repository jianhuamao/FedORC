...
\begin{figure*}[t]
    \centering
    \includegraphics[height=0.19\textwidth]{figure/oracle/theoretical_bound.pdf}
    \hfill
    \includegraphics[height=0.19\textwidth]{figure/oracle/risk_bound.png}
    \hfill
    \includegraphics[height=0.19\textwidth]{figure/oracle/acc.pdf}
